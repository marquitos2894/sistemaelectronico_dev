...
<div class="container-fluid"> 
  <ul class="nav nav-tabs">
      <li class="nav-item">
          <a class="nav-link active" href="<?php echo SERVERURL;?>miFlota/"><i class="fas fa-tractor"></i> Mi flota de Equipos</a>
      </li>
      <li class="nav-item">
          <a class="nav-link" href="<?php echo SERVERURL;?>miFlotaBaja/"><i class="fas fa-tractor"></i> Mi flota dada de baja</a>
      </li>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <button class="btn btn-primary" id="btnAddFlota" data-toggle='modal' data-target='#ModalAddFlota' >+Agregar Equipo</button>
    </div>
  </div>
